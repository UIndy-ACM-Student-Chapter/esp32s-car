...
void Device::begin() {
  ...
  Serial.println("Begining the device.....");
  Serial.println("device_uid:" + Device::readDeviceUid());
  Serial.println("device_pwd:" + Device::readDevicePwd());
  Serial.println("device_pwd:" + Device::readWebHost());

  Device::clearLogin();
  Device::clearLoginTimestamp();
  delay(100);
  Serial.println("Done with begining the device.....");
}
...
// Allowed always login for ESP32
//bool Device::isLogin(int enterTimestamp) {
...
//      Id_Maker.uuid(uuidNumber);
      uuidStr = Uid_Maker::uuidToString();
...
float Device::measureValue(String key) {
   ...
   //String value = valueOfKeyValueStr(MeasureKV, key); //Remove this due to removing Utility.h
   String value = "";
...
void Device::saveMeasureValue(String key, String value) {
   ...
   if (MeasureKV == "") {
       ...
       //String newMeasureKV = saveKeyValueStr(MeasureKV, key, value); //Remove this due to removing Utility.h
       String newMeasureKV = "";
